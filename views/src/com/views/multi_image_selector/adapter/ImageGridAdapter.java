...
import com.views.R;
import com.views.multi_image_selector.MultiImageSelectorFragment;
...
public class ImageGridAdapter extends BaseAdapter {
	...
	class ViewHolder {
		...
		void bindData(final Image data) {
			...
			if (imageFile.exists()) {
				// 显示图片
				Picasso.with(mContext).load(imageFile).placeholder(R.drawable.mis_default_error)
						.tag(MultiImageSelectorFragment.TAG).resize(mGridWidth, mGridWidth).centerCrop().into(image);
			} else {
