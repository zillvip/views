...
import com.views.R;
import com.views.multi_image_selector.adapter.FolderAdapter;
import com.views.multi_image_selector.adapter.ImageGridAdapter;
import com.views.multi_image_selector.bean.Folder;
import com.views.multi_image_selector.bean.Image;
import com.views.multi_image_selector.utils.FileUtils;
import com.views.multi_image_selector.utils.ScreenUtils;
		...
		public Loader<Cursor> onCreateLoader(int id, Bundle args) {
			...
			if (id == LOADER_ALL) {
				...
				cursorLoader = new CursorLoader(getActivity(),
						MediaStore.Images.Media.EXTERNAL_CONTENT_URI, IMAGE_PROJECTION, IMAGE_PROJECTION[4] + ">0 AND "
