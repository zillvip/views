package com.views.pulltorefresh.ui;
...
import com.views.R;
import com.views.pulltorefresh.widget.XScrollView;
	...
	public void onRefresh() {
		mHandler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				mItems.clear();
				geneItems();
				mAdapter = new ArrayAdapter<String>(XScrollViewActivity.this, R.layout.vw_list_item, mItems);
				mListView.setAdapter(mAdapter);
				measureHeight();
				onLoad();
			}
